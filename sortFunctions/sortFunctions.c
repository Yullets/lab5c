...
void compsExperiment() {
    SortFunc sorts[] = {
            {getSelectionSortComp, "getSelectionSortComp"},
            {getInsertionSortComp, "getInsertionSortComp"},
            {getBubbleSortComp,    "getBubbleSortComp"},
            {getCombSortComp,      "getCombSortComp"},
            {getShellSortComp,     "shellSort"},
            {getDigitSortComp,     "radixSort"},
    };
    const unsigned FUNCS_N = ARRAY_SIZE (sorts);
